    ...
    <AppShell>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        ...
        <GlassCard className="p-6">
          ...
          <div className="mt-4 space-y-3 text-sm text-[#CBD5E1]">
            <button className="flex w-full items-center justify-between rounded-xl bg-white/[0.04] px-4 py-3" onClick={() => save({ ...settings, privacy: { ...settings.privacy, strangerChat: !settings.privacy.strangerChat } })}>
              Stranger chat <Badge tone={settings.privacy.strangerChat ? 'success' : 'danger'}>{settings.privacy.strangerChat ? 'Allowed' : 'Blocked'}</Badge>
            </button>
